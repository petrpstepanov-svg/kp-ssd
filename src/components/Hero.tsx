    ...
    >
      ...
      <div className="relative max-w-3xl mx-auto w-full flex flex-col items-center text-center">
        ...
        <motion.h1
          ...
          className="mt-8 text-3xl sm:text-4xl md:text-5xl font-bold text-foreground leading-[1.15] tracking-tight max-w-2xl mx-auto"
        >
          Мы{' '}
        ...
        <motion.p
          ...
          className="mt-6 text-base md:text-lg text-foreground-accent max-w-xl mx-auto text-balance"
        >
        ...
        <motion.div
          ...
          className="flex items-center justify-center gap-3 md:gap-6 mt-10"
        >
          {heroDetails.stats.map((stat) => (
            <div
              key={stat.value}
              className="flex flex-col items-center text-center rounded-xl bg-white border border-gray-100 shadow-sm px-4 py-3 md:px-6 md:py-4"
            >
        ...
        {/* Скриншот ТОП-1 в рамке телефона */}
        <motion.div
        ...
        >
          <div className="rounded-[2rem] border-[8px] border-gray-900 shadow-xl overflow-hidden bg-gray-900 w-64 md:w-80 mx-auto">
            <Image
