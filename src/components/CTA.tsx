import { HiPhone, HiCurrencyDollar } from 'react-icons/hi2';
                ...
                <div className="h-full w-full">
                    ...
                    <div className="h-full flex flex-col items-center justify-center text-white text-center px-5">
                        ...
                        <div className="mt-6 flex flex-col sm:flex-row items-center gap-4">
                            ...
                            >
                                <HiPhone className="w-5 h-5" /> Позвонить
                            </a>
                            <a
                                href="#pricing"
                            ...
                            >
                                <HiCurrencyDollar className="w-5 h-5" /> Смотреть цены
                            </a>
                        </div>

                        <p className="mt-6 text-sm text-orange-200/70">
                            +7 921 704-09-66 · г. Челябинск, пр. Ленина, 27, стр. 4
                        </p>
                    </div>
                </div>
            </div>
